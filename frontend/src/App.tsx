  ...
  return (
    <div className="bg-gray-50 h-screen flex flex-col">
      <div className="my-auto">
        <img src="/medical-icon.svg" className="mx-auto my-4 sm:my-0" width={400} />
            ...
            <div className="relative rounded-2xl px-6 py-6 bg-blue-600 overflow-hidden shadow-xl sm:px-12 sm:py-10">
              ...
              <div className="relative">
                <div className="sm:text-center">
                  <h2 className="text-3xl font-extrabold text-white tracking-tight sm:text-4xl">Corona Data Fetcher</h2>
                ...
                <form action="#" className="mt-12 sm:mx-auto sm:max-w-lg sm:flex">
                  ...
                  <div className="mt-4 sm:mt-0 sm:ml-3">
                    <button
                      type="button"
                      className="block w-full rounded-md border border-transparent px-5 py-3 bg-blue-400 text-base font-medium text-white shadow hover:bg-blue-300 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-blue-600 sm:px-10"
                    >
                      Fetch Data
                    </button>
                  </div>
